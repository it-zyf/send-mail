...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "xyy";
    public static final String MAIL_EXCHANGE_NAME = "xyyExchanges";
    public static final String MAIL_ROUTING_KEY_NAME = "hh.xyy";
}
